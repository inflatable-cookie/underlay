...
const DEFAULT_CSP_CONFIG: ResolvedCspConfig = {
  defaultSrc: ["'self'"],
  scriptSrc: ["'self'"],
...
const DEFAULT_SECURITY_HEADERS: Required<Omit<SecurityHeadersConfig, "permissionsPolicy">> & Pick<SecurityHeadersConfig, "permissionsPolicy"> = {
...
export function createCspConfig(config: CspConfig = {}): ResolvedCspConfig {
  ...
  return {
    defaultSrc: mergeArrays(DEFAULT_CSP_CONFIG.defaultSrc, config.defaultSrc),
    scriptSrc: mergeArrays(DEFAULT_CSP_CONFIG.scriptSrc, config.scriptSrc),
    styleSrc: mergeArrays(DEFAULT_CSP_CONFIG.styleSrc, config.styleSrc),
    imgSrc: mergeArrays(DEFAULT_CSP_CONFIG.imgSrc, config.imgSrc),
    fontSrc: mergeArrays(DEFAULT_CSP_CONFIG.fontSrc, config.fontSrc),
    connectSrc: mergeArrays(DEFAULT_CSP_CONFIG.connectSrc, config.connectSrc),
    frameSrc: mergeArrays(DEFAULT_CSP_CONFIG.frameSrc, config.frameSrc),
    mediaSrc: mergeArrays(DEFAULT_CSP_CONFIG.mediaSrc, config.mediaSrc),
    objectSrc: mergeArrays(DEFAULT_CSP_CONFIG.objectSrc, config.objectSrc),
    formAction: mergeArrays(DEFAULT_CSP_CONFIG.formAction, config.formAction),
    baseUri: mergeArrays(DEFAULT_CSP_CONFIG.baseUri, config.baseUri),
    frameAncestors: mergeArrays(DEFAULT_CSP_CONFIG.frameAncestors, config.frameAncestors),

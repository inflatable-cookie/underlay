<script lang="ts">
  ...
  export let onChange: (block: SummarySlideshowBlock) => void;

  function ensureBlock(
    b: SummarySlideshowBlock | undefined
  ): SummarySlideshowBlock {
    const base: SummarySlideshowBlock =
      b ??
      ({
...
<div class="summary-slideshow-editor">
  <p class="hint">
    Configure slideshow slides. Each slide can reference an image and optional
    markdown body text.
  </p>

  <div class="pages">
    {#if !block.data?.pages || block.data.pages.length === 0}
      <p>No slides defined yet.</p>
    {/if}

    {#each block.data?.pages ?? [] as page, index}
      <div class="page-row">
        <div class="page-meta">
          <span class="page-index">Slide {index + 1}</span>
        ...
        <div class="page-fields">
          ...
          />
          <MarkdownEditor
            placeholder="Slide body (markdown)"

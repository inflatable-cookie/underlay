# g10.024 - Migration And Testing Fleet Closeout
...
Depends on: `g10.019`, `g10.020`, `g10.021`, `g10.022`, `g10.023`
...
- `g10.017`–`g10.023` are complete and merged
...
- every `g10.015` and `g10.016` finding has a completed repair, an explicit
...
Operator selection required before a design card or strict spec can open:
...
compile a separate decision-prototype card before claiming the wave closed.

## Validation

- six-root task and retired-selector inventory
- six-root `effigy test --plan`
- merged per-card validation evidence; do not repeat destructive state applies

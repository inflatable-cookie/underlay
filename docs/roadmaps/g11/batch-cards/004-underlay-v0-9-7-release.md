...
Status: blocked on Card 003 reviewed merge
...
After Card 003 merges, recompile this card against the exact pushed candidate
and run the explicitly approved release sequence.

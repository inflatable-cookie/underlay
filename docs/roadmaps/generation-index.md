...
| `g10` | 2026-08-17 | Contract fidelity, collection convergence, and fleet drift prevention after `g09` closeout | Active - `g10.001` complete; `g10.002` in review and `g10.003` blocked in the monorepo consumer-workspace rollout |
...
Review `g10.002`, then promote `g10.003` after operator-authorized merge. See

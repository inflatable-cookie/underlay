...
| `g09` | 2026-08-03 | Config-convergence follow-through; extended with dependency upgrades, consumer workspace convergence, and contract fidelity | Active - `g09.001`–`g09.059` complete; `g09.060` ready for Contract `023` normalization |
...
Dispatch `g09.060`. See [`g09/README.md`](g09/README.md).

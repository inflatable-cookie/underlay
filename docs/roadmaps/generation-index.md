...
| `g09` | 2026-08-03 | Config-convergence follow-through; extended with dependency upgrades, consumer workspace convergence, and contract fidelity | Active - `g09.001`–`g09.057` and `g09.059` complete; `g09.058` awaits only Acowtancy PR67 |
...
active route-retirement phase. See [`g09/README.md`](g09/README.md).

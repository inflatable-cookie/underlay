...
| `g10` | 2026-08-17 | Contract fidelity, collection convergence, and fleet drift prevention after `g09` closeout | Active - `g10.001`–`g10.011` complete; `g10.012` ready |
...
Execute `g10.012`, the context rejection envelope normalization. See

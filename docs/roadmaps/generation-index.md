...
| `g09` | 2026-08-03 | Config-convergence follow-through; extended with dependency upgrades, consumer workspace convergence, and contract fidelity | Active - `g09.001`–`g09.037` complete; `g09.038`–`g09.045` planned; no ready roadmap until the reference database gate is proven |
...
promote `g09.038`. See [`g09/README.md`](g09/README.md).

...
| `g10` | 2026-08-17 | Contract fidelity, collection convergence, and fleet drift prevention after `g09` closeout | Active - `g10.001`–`g10.003` complete; `g10.004` ready in the monorepo consumer-workspace rollout |
...
See [`g10/README.md`](g10/README.md) and the active strict spec. No other card
is ready.

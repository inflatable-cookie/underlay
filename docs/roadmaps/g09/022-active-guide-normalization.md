...
Repair the retired migration-selector authority found during `g09.021`, then
...
- `g09.021` review found contract `021` still teaching the aliases removed from
...
scan debt; no doctor findings were changed in this roadmap.
...
contract not owned by this roadmap.

## Next Task

Closed after orchestrator review, operator-authorized merge, and planning
currentness repair. Execute `g09.023` through a fresh worker handoff. No other
roadmap is ready.

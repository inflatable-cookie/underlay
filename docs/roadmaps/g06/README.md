...
- `g06.174` is complete as the media Postgres config unchecked constructor
  retirement batch.
- `g06.175` is complete as the post-hardening Rust quality checkpoint.
- `g06.176` is complete as the auth cookie unchecked string setter retirement
  batch.
...
- `g06.179` is complete as the Rust hardening release-note and
  upgrade-guidance closeout.
...
- `g06.198` is complete as the rate-limit config field retirement artifact.
...
- `g06.204` is complete as the DB config field retirement artifact.
- `g06.205` is complete as the outbox config field retirement artifact.
...
- `g06.217` is complete as the job config field retirement artifact.
- `g06` is closed.

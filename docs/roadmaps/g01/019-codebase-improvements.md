...
Address findings from the 2026-02-08 codebase audit (`docs/logs/2026-02/08-000000-codebase-audit.md`). Improvements are grouped into four phases by breaking-change blast radius. Each item that changes public API is followed by updates to all consuming apps.

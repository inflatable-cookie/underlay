...
- [x] Run naming guardrail scripts in all repos (executed 2026-02-25; see `docs/logs/2026-02/25-000000-cross-repo-auth-json-verification.md`).
- [x] Sample key API responses and confirm `snake_case` field names (Songsprout + Acowtancy runtime samples captured; see `docs/logs/2026-02/25-000000-cross-repo-auth-json-verification.md`).

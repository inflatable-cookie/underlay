...
- [x] Publish inventory report: `docs/logs/2026-02/24-000000-acowtancy-env-inventory-and-classification.md`
...
- [x] Run inventory and classification (`docs/logs/2026-02/25-000000-underlay-reference-env-inventory-and-classification.md`)

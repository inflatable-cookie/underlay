...
Update the five consumer apps as part of the same planned work.
...
- publish the final upgrade note for the reset
...
- a compatibility shim would outlive the work that introduced it

...
- [`docs/knowledge/architecture/050-auth-database-schema.md`](../architecture/050-auth-database-schema.md)
- [`docs/knowledge/architecture/055-account-database-schema.md`](../architecture/055-account-database-schema.md)
...
`SessionStore` remains in `underlay-auth-jwt` for now. Moving the
trait behind `underlay-auth` would be another public trait migration and needs a
separate planned task with consumer implementation proof.

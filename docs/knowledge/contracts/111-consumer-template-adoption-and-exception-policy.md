...
- the `g05` roll-up in Git history (Dairy detail/tab, Compli Me/Contact Patch detail, Underlay Reference completion, cross-app media-library, system-index, and admin-dashboard convergence evidence)

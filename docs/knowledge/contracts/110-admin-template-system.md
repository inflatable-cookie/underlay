...
- [`ts/src/templates/index.ts`](../../../ts/src/templates/index.ts)
...
- [`ts/src/templates/EntityListCard.svelte`](../../../ts/src/templates/EntityListCard.svelte)
- [`ts/src/templates/entity-list-card.types.ts`](../../../ts/src/templates/entity-list-card.types.ts)
- [`ts/src/templates/EntityDetailPage.svelte`](../../../ts/src/templates/EntityDetailPage.svelte)
- [`ts/src/templates/EntityDetail.svelte`](../../../ts/src/templates/EntityDetail.svelte)
- [`ts/src/templates/EntityDetailModule.svelte`](../../../ts/src/templates/EntityDetailModule.svelte)
- [`ts/src/templates/EntityInlineListModule.svelte`](../../../ts/src/templates/EntityInlineListModule.svelte)
- [`ts/src/templates/EntityAttributeList.svelte`](../../../ts/src/templates/EntityAttributeList.svelte)
- [`ts/src/templates/EntityFormPage.svelte`](../../../ts/src/templates/EntityFormPage.svelte)
- [`ts/src/templates/MediaUploadPage.svelte`](../../../ts/src/templates/MediaUploadPage.svelte)
- [`ts/src/templates/MediaUploadWorkflowPage.svelte`](../../../ts/src/templates/MediaUploadWorkflowPage.svelte)
- [`ts/src/templates/MediaUploadStatusPanel.svelte`](../../../ts/src/templates/MediaUploadStatusPanel.svelte)
- [`ts/src/templates/MediaReplaceFileForm.svelte`](../../../ts/src/templates/MediaReplaceFileForm.svelte)
- [`ts/src/templates/MediaBrowsePanel.svelte`](../../../ts/src/templates/MediaBrowsePanel.svelte)
- [`ts/src/templates/MediaActionsMenu.svelte`](../../../ts/src/templates/MediaActionsMenu.svelte)
- [`ts/src/templates/MediaListPage.svelte`](../../../ts/src/templates/MediaListPage.svelte)
- [`ts/src/templates/MediaListCard.svelte`](../../../ts/src/templates/MediaListCard.svelte)
- [`ts/src/templates/MediaFileDetailsCard.svelte`](../../../ts/src/templates/MediaFileDetailsCard.svelte)
- [`ts/src/templates/MediaEditDialog.svelte`](../../../ts/src/templates/MediaEditDialog.svelte)
- [`ts/src/templates/MediaPreviewTab.svelte`](../../../ts/src/templates/MediaPreviewTab.svelte)
- [`ts/src/templates/MediaRenditionsSection.svelte`](../../../ts/src/templates/MediaRenditionsSection.svelte)
- [`ts/src/templates/MediaVersionActionDialogs.svelte`](../../../ts/src/templates/MediaVersionActionDialogs.svelte)
- [`ts/src/templates/MediaVersionPreviewDialog.svelte`](../../../ts/src/templates/MediaVersionPreviewDialog.svelte)
- [`ts/src/templates/MediaVersionsList.svelte`](../../../ts/src/templates/MediaVersionsList.svelte)
- [`ts/src/templates/MediaUsageList.svelte`](../../../ts/src/templates/MediaUsageList.svelte)
- [`ts/src/templates/MediaPickerWorkflow.svelte`](../../../ts/src/templates/MediaPickerWorkflow.svelte)
- [`ts/src/templates/MediaDetailWorkflowPage.svelte`](../../../ts/src/templates/MediaDetailWorkflowPage.svelte)
- [`ts/src/templates/SystemIndexPage.svelte`](../../../ts/src/templates/SystemIndexPage.svelte)
- [`ts/src/templates/SystemAuditLogListPage.svelte`](../../../ts/src/templates/SystemAuditLogListPage.svelte)
- [`ts/src/templates/SystemJobDetailPage.svelte`](../../../ts/src/templates/SystemJobDetailPage.svelte)
- [`ts/src/templates/SystemJobListPage.svelte`](../../../ts/src/templates/SystemJobListPage.svelte)
- [`ts/src/templates/SystemMediaTrashListPage.svelte`](../../../ts/src/templates/SystemMediaTrashListPage.svelte)
- [`ts/src/templates/SystemMediaTrashListCard.svelte`](../../../ts/src/templates/SystemMediaTrashListCard.svelte)
- [`ts/src/templates/SystemScheduledTaskDetailPage.svelte`](../../../ts/src/templates/SystemScheduledTaskDetailPage.svelte)
- [`ts/src/templates/SystemScheduledTasksListPage.svelte`](../../../ts/src/templates/SystemScheduledTasksListPage.svelte)
- [`ts/src/templates/SystemScheduledTaskListCard.svelte`](../../../ts/src/templates/SystemScheduledTaskListCard.svelte)
- [`ts/src/templates/AdminDashboardPage.svelte`](../../../ts/src/templates/AdminDashboardPage.svelte)
- [`ts/src/templates/ErrorLogListPage.svelte`](../../../ts/src/templates/ErrorLogListPage.svelte)
...
- [`docs/usage/templates/template-api-reference.md`](../../usage/templates/template-api-reference.md)
- [`docs/usage/templates/consumer-rollout.md`](../../usage/templates/consumer-rollout.md)

Rollout evidence:

- the `g03` roll-up in Git history (generation rollover, Acme list/detail proofs, Dairy validation, and entity-form evidence)

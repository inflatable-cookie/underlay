...
- the `g05` roll-up in Git history (cross-app media-library consolidation evidence)
- [`docs/knowledge/contracts/media-capability/fleet-media-capability-matrix.csv`](media-capability/fleet-media-capability-matrix.csv)

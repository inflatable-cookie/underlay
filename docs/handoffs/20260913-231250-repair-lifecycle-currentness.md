...
title: "g12.003 — Repair lifecycle currentness"
...
- Canonical task: [`g12.003`](../roadmaps/g12/003-repair-lifecycle-currentness.md).
- Planning base before this handoff: `c23f6152be2683575904b9685f427e6be95c448a`.
- The integration checkout was clean and synchronized before promotion.
- Exact currentness findings:
- `docs/roadmaps/README.md` — `stale-frontier` in `Next Task` for `g12.002`
- `docs/roadmaps/g11/README.md` — `duplicate-status-header` in `g11 - Immutable Verified Media Publication`
- `docs/roadmaps/g12/README.md` — `stale-frontier` in `Next Task` for `g12.002`
- `docs/roadmaps/g12/README.md` — `duplicate-status-header` in `g12 - Standalone Nightfire Package`

...
Generated: 2026-02-25T10:56:22Z

## Automated Baseline

- Readiness gate (`SKIP_GOOGLE_OAUTH_CHECKS=1`): **PASS**
...
[PASS] Songsprout API auth login route reachable (405)
...
Date: 2026-02-25T10:56:23Z

## Songsprout Bloom (server auth actions)

 RUN  v4.0.18 /Users/betterthanclay/Dev/projects/songsprout/bloom

 ✓ src/lib/server-tests/security-page.server.test.ts (7 tests) 58ms
 ✓ src/lib/server-tests/auth-login-page.server.test.ts (7 tests) 61ms

 Test Files  2 passed (2)
      Tests  14 passed (14)
   Start at  10:56:23
   Duration  216ms (transform 155ms, setup 46ms, import 82ms, tests 119ms, environment 0ms)
...
## Acowtancy Dairy (browser-path auth route)
 ...
 ✓ tests/auth-login-page.test.ts (2 tests) 269ms

 Test Files  1 passed (1)
      Tests  2 passed (2)
   Start at  10:56:24
   Duration  2.22s (transform 448ms, setup 0ms, import 521ms, tests 269ms, environment 1.33s)

...
- `docs/roadmaps/g01/004-underlay-auth-system-roadmap.md`
- `docs/roadmaps/g01/005-auth-database-migrations.md`
- `docs/roadmaps/g01/006-rust-test-coverage-improvement.md`
- `docs/roadmaps/g01/015-unified-error-reporting-roadmap.md`
- `docs/roadmaps/g01/016-json-naming-standardization-roadmap.md`
- `docs/roadmaps/g01/020-configuration-standardization-and-env-reduction.md`

Also normalized status drift where roadmap files had no open checkboxes but were still marked in progress:

- `docs/roadmaps/g01/002-frontend-extraction-roadmap.md` -> Complete
- `docs/roadmaps/g01/003-frontend-guardrails-and-quirk-management.md` -> Complete
- `docs/roadmaps/g01/019-codebase-improvements.md` -> Complete

...
- [ ] `docs/roadmaps/g01/015-unified-error-reporting-roadmap.md` success metrics checked complete.
- [ ] `docs/roadmaps/g01/016-json-naming-standardization-roadmap.md` success metrics checked complete.
- [ ] `docs/roadmaps/README.md` status counts updated.

...
Date: 2026-08-25
Roadmap: `docs/roadmaps/g09/023-workspace-shape-conformance.md`
...
- `g09.024` is ready after review and merge

## Next task

Execute `g09.024` — Acowtancy evidence repair — through a fresh
orchestrator-dispatched Acowtancy worker handoff. No other roadmap is ready.

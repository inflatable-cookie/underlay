...
| [023-release-and-compatibility-rollout.md](./023-release-and-compatibility-rollout.md) | active | fleet rollout order, compatibility windows, upgrade notes, and retirement proof for shared changes | `001`, `027`, `111`, `190`, `g01.031`, six-consumer rollout evidence | `g09.060` planned behind papercuts wave 3 to normalize stale path/file dependency teaching onto released tags |
...
Close papercuts wave 3, then promote `g09.060`. See

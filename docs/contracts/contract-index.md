...
| [118-front-and-shared-read-api-shapes.md](./118-front-and-shared-read-api-shapes.md) | planned | front/public/shared read envelopes, canonical read-route families, helper vs page-shaped read surfaces | current consumer routers, `020`, `115`, `116` | extends the page-shape line beyond admin templates so normal non-admin read surfaces are also declared |
...
5. storage and media
6. jobs and operator systems
7. Nightfire and migration
8. AI and suggestions
9. TS runtime/client orchestration
10. shared patterns
11. admin templates
12. front/shared read API shapes
13. tooling and contract artifacts

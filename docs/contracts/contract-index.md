...
| [024-new-app-bootstrap-and-bring-up.md](./024-new-app-bootstrap-and-bring-up.md) | active | single-repository `apps/*`/`packages/*` topology, normative root Bun manifest, released-dependency rule, docs authority, Effigy-first bootstrap and bring-up posture | `docs/specs/monorepo-consumer-workspace-rollout.md`, acowtancy, `025`, `110`, `120` | settles that a normal Underlay product is one Git repository, what it contains on day one, and how it should start cleanly |

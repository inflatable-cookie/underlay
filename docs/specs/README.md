...
Await review and merge of `g09.046`. The compiled bootstrap/runtime/access wave
is governed by numbered roadmaps `g09.046`–`g09.053`; no batch card or strict
spec replaces that queue.

...
Review `g10.003` from the active spec. `g10.004` remains blocked until merge.
Do not open a second strict lane that shares consumer workspace, bootstrap,
package, or conformance surfaces.

...
| 002 | [Frontend Extraction](./002-frontend-extraction-roadmap.md) | Complete | Extract shared TS/Svelte components |
| 003 | [Frontend Guardrails](./003-frontend-guardrails-and-quirk-management.md) | Complete | Svelte/TS guardrails and quirk management |
| 004 | [Auth System](./004-underlay-auth-system-roadmap.md) | Complete | Authentication provider system |
| 005 | [Auth DB Migrations](./005-auth-database-migrations.md) | Complete | Auth-related database schema migrations |
| 006 | [Rust Test Coverage](./006-rust-test-coverage-improvement.md) | Complete | Improve test coverage across Rust crates |
| 007 | [Quickstart Guide](./007-quickstart-guide-improvements.md) | Complete | Improve new-project quickstart docs |

<script lang="ts">
  ...
  let linkClass = $derived(
    variant === "mobile" ? "admin-mobile-overlay__link" : "admin-nav__root",
  );
...
<ul class={variant === "mobile" ? "admin-mobile-overlay__list" : "admin-nav__list"}>
  <li>
    <a
      ...
      class:admin-nav__link--active={isActive("/")}
  ...
  <li>
    <button
      ...
      aria-expanded={expandedSection === "content"}
      onclick={() => toggleSection("content")}
    >
      <span class="admin-nav__badge admin-nav__badge--content" aria-hidden="true">
        <Library class="admin-nav__badge-icon" />
      </span>
      <span class={variant === "desktop" ? "admin-nav__label" : ""}>Content</span>
    ...
    {#if expandedSection === "content"}
      <ul class={childrenClass}>
        <li>
          <a
            href="/content"
            class:admin-nav__link--active={isActive("/content")}
            onclick={handleChildClick}
          >
            Overview
          </a>
    ...
    {#if expandedSection === "system"}
      <ul class={childrenClass}>
        <li>
          <a
            href="/system"
            class:admin-nav__link--active={isActive("/system")}
            onclick={handleChildClick}
          >
            Overview
          </a>
...
<style>
  ...
  :global(.admin-nav__badge--content) {

...
1. **Use shared types** - Import from `underlay-db` (Rust) or `@inflatable-cookie/underlay/runtime/media/types` (TypeScript)
...
| TypeScript types | `@inflatable-cookie/underlay/runtime/media/types` | Types, enums, labels, and media utility functions |
...
| Upload pattern | `@inflatable-cookie/underlay/runtime/media/upload` | `createMediaUploadFlow` |
...
All media types are exported from `@inflatable-cookie/underlay/runtime/media/types`.
The aggregate `@inflatable-cookie/underlay/runtime/media` path remains valid for
compatibility:
...
```typescript
import { createMediaUploadFlow, type MediaUploadFlowController } from "@inflatable-cookie/underlay/runtime/media/upload";
...
`@inflatable-cookie/underlay/runtime/media/upload` instead of hand-wrapping
